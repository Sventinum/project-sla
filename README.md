...
<table class="iksweb">
	<tbody>
		<tr>
			<td>Влияние на работу пользователей</td>
			<td colspan="3">	Количество вовлеченных пользователей</td>
		</tr>
		<tr>
			<td></td>
			<td>Один</td>
		...
		<tr>
			<td>Полная неработоспособность</td>
			<td>2</td>
			<td>2</td>
			<td>1</td>
		</tr>
		<tr>
			<td>Неработоспособность одного или нескольких приложений</td>
			<td>3</td>
			<td>2</td>
			<td>1</td>
		</tr>
		<tr>
			<td>Неработоспособность некоторых функций приложений</td>
			<td>3</td>
			<td>2</td>
			<td>2</td>
		</tr>
...
| Действие | Тип | Срок(часы) |
| ------------- | ------------- | ------------- |
| 1.Обслуживание серверов  | Т4 |  96 |
| 1.1 Диагностика неисправностей  | T1  | 20 |
| 1.2 Установка системных обновлений (критические патчи, сервис-паки) обновлений антивирусных баз  | T1 | 12 |
| 1.3 Восстановление данных и системы при сбоях  | T3  | 8 |
| 2. Обслуживание рабочих станций  | T4  | 168  |
| 2.1 Диагностика неисправностей (эскалация с уровня Service Desk)  | T2 | 48 |
| 2.2 Восстановление системы после сбоев  | T3 | 8 |
| 3 Обслуживание сетевого оборудования  | T4 | 72  |
| 3.1 Установка нового коммутатора  |  T1 | 12  |
| 3.2 Замена коммутаторов при сбоях  |  T3 | 4  |
